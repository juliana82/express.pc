...
// salvar alterações feitas no editar.html
document.getElementById('form-edicao-usuario').addEventListener('submit', function(event) {
            ...
            const turno = document.getElementById('turno-usuario').value.trim();
            const turma = document.getElementById('turma-usuario').value.trim();
...
// tirar a fotinha na página de cadastro incomplet
 function capturarFoto() {
            alert("Função de captura de foto a ser implementada.");
        }